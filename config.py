...
5. КРИТИЧЕСКИ ВАЖНО: ЗАПРЕЩЕНО использовать теги <p>, <h1>, <h2>, <h3>, <div>, <br>, <ul>, <li>, <think> и любые другие веб-теги! 
Для абзацев используй обычный перенос строки. Не используй Markdown и никогда не обворачивай ответ в блоки кода (```html ... ```)"""
